defmodule Diggers.Board do
  ...
  def add_tile(board, x, y, terrain, accepted_rolls) do
    put_in(board, [:tiles, {x, y}], %{x: x, y: y, terrain: terrain, accepted_rolls: accepted_rolls})
  end


  def add_diamond(board, x, y, type) do
    put_in(board, [:diamonds, {x, y}], %{x: x, y: y, type: type})
  end


  def start_at(board, x, y) do
    put_in(board.start_tile, {x, y})
  end


  def exit_at(board, x, y) do
    put_in(board.exit_tile, {x, y})
  end
  ...
  def diamond?(board, tile) do
    Map.has_key?(board.diamonds, tile)
  end


  def accepted_rolls(board, tile) do
    board.tiles[tile].accepted_rolls
  end
  ...
  def on_board?(board, tile) do
    Map.has_key?(board.tiles, tile)
  end
