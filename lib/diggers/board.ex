defmodule Diggers.Board do
  ...
  def disease_it do
    new()
      |> add_tile({3, 2}, "forest_11", [6])
      |> add_tile({3, 1}, "grassland_1", [1])
      |> add_tile({2, 1}, "mountain_12", [6])
      |> add_tile({2, 2}, "grassland_1", [6])
      |> add_tile({-2, -3}, "grassland_1", [6])
      |> add_tile({-4, -3}, "mountain_9", [6])
      |> add_tile({-4, -2}, "forest_16", [6])
      |> add_tile({-4, -1}, "grassland_16", [6])
      |> add_tile({-3, -3}, "forest_17", [3])
      |> add_tile({0, -2}, "forest_17", [6])
      |> add_tile({-2, -2}, "grassland_16", [2])
      |> add_tile({-1, -2}, "forest_11", [3])
      |> add_tile({-3, -1}, "forest_19", [5])
      |> add_tile({-2, -1}, "mountain_2", [3])
      |> add_tile({-1, -1}, "mountain_5", [3])
      |> add_tile({0, -1}, "forest_11", [4])
      |> add_tile({1, -1}, "grassland_4", [6])
      |> add_tile({-2, 0}, "forest_11", [3])
      |> add_tile({-1, 0}, "grassland_1", [1])
      |> add_tile({0, 0}, "forest_11", [4])
      |> add_tile({1, 0}, "grassland_10", [6])
      |> add_tile({-2, 1}, "grassland_10", [6])
      |> add_tile({-1, 1}, "grassland_19", [6])
      |> add_tile({0, 1}, "grassland_10", [1])
      |> add_tile({1, 1}, "grassland_16", [2])
